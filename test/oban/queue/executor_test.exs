defmodule Oban.Queue.ExecutorTest do
  ...
  defmodule Worker do
    ...
    def perform(%{"mode" => "warn"}, _job), do: {:ok, :this_will_warn}
  ...
  describe "safe_call/1" do
    ...
    test "warning on unexpected return values" do
      ...
      assert message =~ "Expected Elixir.Oban.Queue.ExecutorTest.Worker.perform/2"
      assert message =~ "{:ok, :this_will_warn}"
    end
  end
end
